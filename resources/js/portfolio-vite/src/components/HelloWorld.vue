    ...
    <section id="about" class="about">
      <section id="home" class="">
        ...
        <div class="row">
          <div class="content">
            <p>
              This unit focuses on customising and developing solutions for
              clients by providing advice and end-to-end support for the entire
              product-development life-cycle in organisations.
            </p>
          </div>
        </div>
